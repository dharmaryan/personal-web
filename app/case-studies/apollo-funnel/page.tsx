        ...
        <div className='mt-12 space-y-10 leading-relaxed'>
          ...
          <section className='space-y-4'>
            ...
            <div className='space-y-4'>
              <div>
                <p className='font-semibold text-slate-900'>Target Criteria</p>
              ...
              <div>
                <p className='font-semibold text-slate-900'>Operating Cadence</p>
                <ul className='mt-2 list-disc space-y-1 pl-5'>
              ...
              <div>
                <p className='font-semibold text-slate-900'>Conversion Rules</p>
                <ul className='mt-2 list-disc space-y-1 pl-5'>
          ...
          <section className='space-y-4'>
            <h2 className='text-2xl font-semibold text-slate-900'>July: Gaining Traction</h2>
            <p>
          ...
          <section className='space-y-4'>
            <h2 className='text-2xl font-semibold text-slate-900'>August – September: The Chaos Spike</h2>
            <p>
          ...
          <section className='space-y-4'>
            <h2 className='text-2xl font-semibold text-slate-900'>Key Learnings &amp; What Didn’t Work</h2>
            ...
            <ul className='list-disc space-y-1 pl-5'>
              ...
              <li>
                “Why would you ever leave PE? Seems like an awful waste of effort – why don’t you wait for the big bucks to come
                in?”
              </li>
          ...
          <section className='space-y-4'>
            <h2 className='text-2xl font-semibold text-slate-900'>Conclusion: A Job Search Is a Sales Funnel</h2>
            <p>
