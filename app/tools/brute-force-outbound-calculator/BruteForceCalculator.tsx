...
const inputClassName =
  "w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-zinc-900 focus:border-zinc-900 focus:outline-none";
...
export default function BruteForceCalculator() {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-zinc-200 bg-white p-6 sm:p-8">
      <div className="flex items-center justify-between gap-3">
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-zinc-500">Outbound Planner</p>
          <h2 className="text-xl font-semibold text-zinc-950">Scenario Calculator</h2>
        </div>
        <span className="rounded-md border border-zinc-200 px-3 py-1 text-xs font-medium text-zinc-700">Live</span>
      </div>
      ...
      <div className="mt-8 rounded-2xl border border-zinc-200 bg-white p-6">
        <p className="text-sm font-medium text-zinc-700">Total messages required</p>
        <div className="mt-2 text-4xl font-bold text-zinc-950 sm:text-5xl">
          {totalMessages.toLocaleString()}
        </div>
        <div className="mt-2 inline-flex items-center gap-2 rounded-md border border-zinc-200 bg-zinc-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-zinc-700">
        ...
        <dl className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-4">
            <dt className="text-xs uppercase tracking-wide text-zinc-600">Messages / week</dt>
            <dd className="mt-1 text-lg font-semibold text-zinc-950">
              {messagesPerWeek.toLocaleString()}
            </dd>
          </div>
          <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-4">
            <dt className="text-xs uppercase tracking-wide text-zinc-600">Messages / day</dt>
            <dd className="mt-1 text-lg font-semibold text-zinc-950">
              {messagesPerDay.toLocaleString()}
            </dd>
          </div>
          <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-4">
            <dt className="text-xs uppercase tracking-wide text-zinc-600">Timeline</dt>
            <dd className="mt-1 text-lg font-semibold text-zinc-950">{timelineWeeks} weeks</dd>
          </div>
        </dl>
        ...
        <div className="mt-6">
          ...
          <div className="flex items-end gap-1.5 rounded-xl border border-zinc-200 bg-zinc-50 p-3">
            {bars.map((bar) => (
