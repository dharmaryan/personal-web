  ...
  return (
    <main className="relative flex min-h-screen items-stretch text-ink">
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-12 px-6 py-12 lg:px-10 lg:py-16">
        <section id="home" className="relative flex flex-col gap-6 overflow-hidden rounded-3xl border border-white/50 bg-warm-beige/80 p-6 shadow-[0_15px_55px_-35px_rgba(17,17,17,0.55)] backdrop-blur-lg">
          <div
          ...
          <div className="relative flex flex-wrap items-center justify-between gap-4">
            ...
            <nav aria-label="Primary" className="rounded-full border border-white/50 bg-warm-beige/70 px-2 py-1 shadow-sm backdrop-blur">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap items-center gap-3 text-sm font-semibold text-earth-olive">
                  <Link
                    ...
                    className="inline-flex items-center rounded-full bg-brand-blue px-5 py-3 text-sm font-semibold text-warm-beige shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-earth-olive"
                  >
                    LinkedIn
                  </Link>
                  <Link
                    href={headerCopy.email}
                    className="inline-flex items-center rounded-full border border-earth-olive/20 bg-warm-beige/80 px-5 py-3 text-sm font-semibold text-earth-olive shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-earth-olive"
                  >
                    Email
                  </Link>
                </div>
        ...
        <section id="about" className="relative overflow-hidden rounded-3xl border border-white/50 bg-warm-beige/85 p-6 shadow-[0_20px_65px_-45px_rgba(17,17,17,0.55)] backdrop-blur-md">
        ...
        <section id="projects" className="relative overflow-hidden rounded-3xl border border-white/50 bg-warm-beige/85 p-6 shadow-[0_20px_65px_-45px_rgba(17,17,17,0.55)] backdrop-blur-md">
        ...
        <section id="contact" className="relative overflow-hidden rounded-3xl border border-white/50 bg-warm-beige/85 p-6 text-center shadow-[0_20px_65px_-45px_rgba(17,17,17,0.55)] backdrop-blur-md">
...
function ProjectCard({
  ...
  return (
    <Link
      href={href}
      className="block h-full rounded-3xl border border-white/60 bg-warm-beige/80 p-6 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-earth-olive"
    >
